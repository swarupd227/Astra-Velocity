      ...
      {open && (
        <div className="fixed inset-0 z-[60] md:hidden">
          ...
          <div
            ...
            className="drawer-in absolute inset-y-0 left-0 flex w-72 max-w-[85vw] flex-col border-r border-slate-800 bg-slate-950 shadow-2xl shadow-slate-950"
          >
            <div className="flex items-start justify-between px-5 pb-4 pt-5">
              ...
              <button
                ...
                onClick={() => setOpen(false)}
                className="rounded-lg p-1.5 text-slate-400 transition hover:bg-slate-800/70 hover:text-white"
              >
